...
3 fichiers pour créer une appli angular
----------------------------------------
...
Tout traitement qui modifie la vue doit préférablement utiliser les pipes
plutôt qu'une méthode. Ceci pour un gain de performance énorme
...
L'utilisation de l'un ou l'autre est à voir au cas par cas mais de manière générale, 
préférer le markForCheck qui est moins violent car c'est Angular qui le gère.
...
Model-driven-form : la logique est dans le controller
